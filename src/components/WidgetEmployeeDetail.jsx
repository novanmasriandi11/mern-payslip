...
const WidgetEmployeeDetail = ({ dataEvent, employeeId }) => {
  ...
  return (
    <>
      ...
      <Modal
        ...
        title={`Detail Employee ${employee.firstName} ${employee.lastName}`}
        IconTitle={<PiUserListDuotone className="text-3xl mr-3" />}
      >
        <Modal.Body
          content={
            <>
        ...
        />
        <Modal.Footer btnYes={"Save Changes"} onClick={update} />
      </Modal>
    </>
  );
};
